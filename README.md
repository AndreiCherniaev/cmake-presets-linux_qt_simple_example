...
3. У меня много [экзотических](https://habr.com/ru/articles/551342/) кастомных сборок Qt, но по-умолчанию мне нужна одна конкретная сборка (известен полный путь);
